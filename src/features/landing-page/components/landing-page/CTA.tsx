...
export default function CTASection() {
  return (
    <Card className='container mx-auto bg-background !ext-foreground dark:hover:bg-muted/20 hover:bg-muted rounded-[20px] flex flex-col gap-6 md:gap-8 items-center justify-center py-6 md:py-8 px-4 transition-all'>
