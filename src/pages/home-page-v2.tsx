...
const locationsList = [
  { id: 4, name: "Rustic Barn", type: "Rural", price: 600, rating: 4.5, address: "123 Countryside Lane" },
  { id: 5, name: "Modern Office Space", type: "Urban", price: 1500, rating: 4.7, address: "456 Business Ave" },
  { id: 6, name: "Cozy Cafe", type: "Urban", price: 400, rating: 4.4, address: "789 Main Street" },
  { id: 7, name: "Abandoned Warehouse", type: "Industrial", price: 700, rating: 4.2, address: "101 Factory Road" },
  { id: 8, name: "Luxury Penthouse", type: "Urban", price: 2000, rating: 4.9, address: "1 Skyline Drive" },
]
          ...
          <ul className="space-y-2">
            {categories.map((category) => (
              <li key={category.name}>
                <Button
                  variant="ghost"
                  className={`w-full justify-start ${category.name === "Locations" ? "bg-blue-100 text-blue-600" : ""}`}
                >
        ...
        <header className="bg-white border-b border-gray-200 p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center flex-1">
              <Input type="search" placeholder="Search for locations..." className="max-w-md" />
